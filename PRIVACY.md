...
completed or was skipped, one boolean saying whether it altered the text, and the counts and fixed outcome of a snippet import or of a word import from another app (never a trigger, a snippet's text, or a word). They cannot carry transcript,
