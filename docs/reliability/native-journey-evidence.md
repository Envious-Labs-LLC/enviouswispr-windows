...
| 2026-09-21 | 0.19.0+ac917bc (step 17: the session's disposal sequenced by the executor, the polish runtime's abort a lifetime step, the session asked to shut down only behind a finished drain) | live-cable-parakeet | yes | yes | 0 |
| 2026-09-21 | 0.19.0+ac917bc (step 17) | live-cable-whisper | yes | yes | 0 |
| 2026-09-21 | 0.19.0+ac917bc (step 17) | synthetic-quick-tap-preview | yes | yes | 0 |
| 2026-09-21 | 0.19.0+ac917bc (step 17) | escape-recovery | yes | yes | 0 |
...
asked to shut down only behind a finished presentation drain; the clean exit and the absence of stray
workers are what they establish natively. The same seven runs also passed on the branch's earlier
build 721f911 (not recorded separately).
...
| 2026-09-21 | 0.19.0+ac917bc (step 17) | edit | UiAutomationValue (`WM_SETTEXT` seen, no `WM_PASTE`, seed first) | yes | yes |
| 2026-09-21 | 0.19.0+ac917bc (step 17) | caret-start | ClipboardPaste (`WM_PASTE` seen, seed last; the sentinel check the harness requires for a pass) | yes | yes |
| 2026-09-21 | 0.19.0+ac917bc (step 17) | password | ClipboardOnly (`TextDeliveryRefused` / `DeliveryProtectedField`, field empty) | yes | yes |
