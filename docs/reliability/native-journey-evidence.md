...
| 2026-09-21 | 0.19.0+d4417ad (step 17: the session's disposal sequenced by the executor, the polish runtime's abort a lifetime step, the session asked to shut down only behind a finished drain, the launch's tail and a model delivery joined by the lifetime) | live-cable-parakeet | yes | yes | 0 |
...
| 2026-09-21 | 0.19.0+bdd260c (step 18: a refused preview stop ended before the final transcription, or the dictation ended rather than transcribed beside it) | live-cable-parakeet | yes | yes | 0 |
| 2026-09-21 | 0.19.0+bdd260c (step 18) | live-cable-whisper | yes | yes | 0 |
| 2026-09-21 | 0.19.0+bdd260c (step 18) | synthetic-quick-tap-preview | yes | yes | 0 |
| 2026-09-21 | 0.19.0+bdd260c (step 18) | escape-recovery | yes | yes | 0 |
...
lifetime's own "polish runtime abort" step rather than inside the shell's closing, and with the session
asked to shut down only behind a finished presentation drain and the launch's tail a tracked task the
lifetime joins; the clean exit and the absence of stray workers are what they establish natively. The
same seven runs also passed on the branch's earlier builds 721f911 and ac917bc (not recorded separately).
...
| 2026-09-21 | 0.19.0+bdd260c (step 18) | edit | UiAutomationValue (`WM_SETTEXT` seen, no `WM_PASTE`, seed first) | yes | yes |
| 2026-09-21 | 0.19.0+bdd260c (step 18) | caret-start | ClipboardPaste (`WM_PASTE` seen, seed last; the sentinel check the harness requires for a pass) | yes | yes |
| 2026-09-21 | 0.19.0+bdd260c (step 18) | password | ClipboardOnly (`TextDeliveryRefused` / `DeliveryProtectedField`, field empty) | yes | yes |
