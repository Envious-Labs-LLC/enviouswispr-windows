...
| CUDA runtime subset | NVIDIA's CUDA EULA limits redistribution to identified distributable portions | Not in the Store package. Four files (cuBLAS, cuBLASLt, CUDA runtime, cuFFT from the NVIDIA wheels nvidia-cublas 13.6.0.2, nvidia-cuda-runtime 13.3.29, nvidia-cufft 12.3.0.29) pinned by size and SHA-256 in the `cuda-runtime` delivery manifest and downloaded on demand; Attachment A confirmation, mirror upload, and approval pending |
| cuDNN runtime subset | NVIDIA's cuDNN agreement identifies runtime `.dll` files as distributable subject to its requirements | Not in the Store package. Eight `cudnn*64_9.dll` files from the NVIDIA wheel nvidia-cudnn-cu13 9.24.0.43, in the same `cuda-runtime` manifest; downstream terms, mirror upload, and approval pending |
...
| British spelling table (`british-spelling.json`) | VarCon 2020.12.07, under its own copyright notice: permission to use, copy, modify, distribute and sell with the notice retained; 5,763 forms generated by the macOS repository's pinned `generate-british-spelling.py` (VarCon tarball SHA-256 `3b0720c5718008f37c02658a83d51d5598dd86531f0a2206d410c854006cb184`; table SHA-256 `d615937cbae19406fee75583454875e7de41f2184da602414bcd7fe6012a3a63`), byte-identical to the macOS copy | Notice shipped as `licenses/varcon-LICENSE.txt` beside the app; public distribution approval pending with the rest of this table |
